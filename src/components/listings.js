            ...
            <div class="listing_item_box wow fadeInUp">
                <div class="listghor_img">
                    ...
                    <div class="listing_info">
                        <div class="post_info">
                            <h3><a href={`/details/${props.data.name}`} style={{textDecoration:'none'}}>{props.data.name}</a>
                            <button onClick={handlePopupOpen} style={{float:'right'}} class="icon"><i class="fa fa-info-circle"></i></button></h3>
